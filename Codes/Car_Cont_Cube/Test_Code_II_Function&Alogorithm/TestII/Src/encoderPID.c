...
//static int32_t getEncoderDiffL(void)
//{
//	return valEncoderL - 5000; // - saveEncoderL;
//}	

//static int32_t getEncoderDiffR(void)
//{
...
//static int32_t positionPIDL(int32_t encoderPosL, int32_t targetPosL)
//{ 	
...
////PWM = Kp * e(k) + Ki * ¡Æe(k) + Kd * [e(k) - e(k-1)]
//static int32_t positionPIDR(int32_t encoderPosR, int32_t targetPosR)
//{ 	
//	static float Kp = 0.7, Ki = 0.0001, Kd = 0.15;
...
//static int32_t incrementalPIDL(int32_t encoderDiffPulseL, int32_t targetSpeedL)
//{ 	
...
////PWM += Kp * [e(k) - e(k-1)] + Ki * e(k) + Kd * [e(k) - 2 * e(k-1) + e(k-2)]
//static int32_t incrementalPIDR(int32_t encoderDiffPulseR, int32_t targetSpeedR)
//{ 	
//	static float Kp = 70.7, Ki = 0.1, Kd = 0.01;
...
//static void straightPIDConstraint(void) //A same speed constraint for going straight. Be called in every 100ms.
//{
//	//PWM += Kp * [e(k) - e(k-1)] + Ki * e(k) + Kd * [e(k) - 2 * e(k-1) + e(k-2)]
